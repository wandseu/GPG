...
{
    public partial class CountriesUControl : UserControl
    {
        public CountriesUControl()
        {
            InitializeComponent();
        }
        ...
        private void CountriesUControl_Load(object sender, EventArgs e)
        {
            RandomWord();
        }
        ...
        {
            PGamePanel.Controls.Clear();
            PGamePanel.Controls.Add(new CountriesUControl());
