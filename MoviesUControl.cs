...
{
    public partial class MoviesUControl : UserControl
    {
        public MoviesUControl()
        {
            InitializeComponent();
        }
        ...
        private void MoviesUControl_Load(object sender, EventArgs e)
        {
            RandomWord();
        }
        ...
        private void NextRoundBttn_Click(object sender, EventArgs e)
        {
            ...
            PGamePanel.Controls.Add(new MoviesUControl());
