...
{
    public partial class GamesUControl : UserControl
    {
        public GamesUControl()
        {
            InitializeComponent();
        }
        ...
        private void GamesUControl_Load(object sender, EventArgs e)
        {
            RandomWord();
        }
        ...
        private void NextRoundBttn_Click(object sender, EventArgs e)
        {
            ...
            PGamePanel.Controls.Add(new GamesUControl());
