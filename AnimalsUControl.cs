...
{
    public partial class AnimalsUControl : UserControl
    {
        public AnimalsUControl()
        {
            InitializeComponent();
        }
        ...
        private void AnimalsUControl_Load(object sender, EventArgs e)
        {
            RandomWord();
        }
        ...
        {
            PGamePanel.Controls.Clear();
            PGamePanel.Controls.Add(new AnimalsUControl());
