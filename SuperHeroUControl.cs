...
{
    public partial class SuperHeroUControl : UserControl
    {
        public SuperHeroUControl()
        {
            InitializeComponent();
        }
        ...
        private void SuperHeroUControl_Load(object sender, EventArgs e)
        {
            RandomWord();
        }
        ...
        private void NextRoundBttn_Click(object sender, EventArgs e)
        {
            ...
            PGamePanel.Controls.Add(new SuperHeroUControl());
